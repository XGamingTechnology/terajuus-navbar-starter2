    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={index} className="bg-orange-100 p-8 rounded-xl shadow-lg text-center cursor-pointer group" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div className="bg-cover bg-center rounded-xl overflow-hidden h-96 md:h-[500px]" style={{ backgroundImage: "url('/Journey.png')" }} initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-700">Tim leadership yang berpengalaman di bidang energi dan pertambangan</p>
          </div>
            ...
            {boardMembers.map((member, index) => (
              <motion.div key={index} className="relative group rounded-xl overflow-hidden shadow-xl" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }}>
                ...
                <div className="absolute bottom-0 w-full bg-white/90 group-hover:translate-y-0 translate-y-full transition-transform duration-500 p-4 backdrop-blur-md">
                  ...
                  <p className="text-blue-700 font-semibold">{member.position}</p>
      ...
      <section className="py-12 bg-gray-100">
        <div className="text-center">
          <Link to="/" className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 px-8 rounded-full transition duration-300">Kembali ke Home</Link>
        </div>
      </section>
    </div>
  );
